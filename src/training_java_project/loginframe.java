...
public class loginframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(304, 10, 316, 22);
        ...
        jPanel1.setBounds(298, 0, 360, 390);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/training_java_project/key-keyhole-1841459.jpg"))); // NOI18N
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        String Sql;
        Sql = "select * from newlogin where username =? and password =?";
        try{
                    ...
                    rs=pst.executeQuery();
                    if(rs.next()){
                        JOptionPane.showMessageDialog(null,"Welcome to the medical store");
                        dispose();
                        view w=new view();
                        w.setVisible(true);
                    }
                    else{
                        JOptionPane.showMessageDialog(null,"Unable to login","Access Denied",JOptionPane.ERROR_MESSAGE);
                    }
                }
